...
class AgcBarleyHarvestLoss {
    ...
    render() {
        return (h("div", null,
            h("form", { onSubmit: (e) => e.preventDefault(), ref: c => this.form = c, "data-wizard": "agc-barley-harvest-loss", "data-wizard-mode": this.mode, class: "agc-wizard" },
                h("slot", null),
                h("section", { "data-wizard-section": "0" },
                    h("div", { class: "agc-wizard__field" },
                        ...
                        h("p", { "data-i18n": `hints.kernels-counted` }, "\u2BA4 Enter the number of barley kernels counted on the ground within the specified area.")),
                ...
                h("section", { "data-wizard-section": "1" },
                    h("div", { class: "agc-wizard__field" },
                        ...
                        h("p", { class: "agc-wizard__validation-message", "data-i18n": "validation.loss-area.required", "data-validates": "lossArea" }, "Please enter a whole number of one or more."),
                        h("p", { "data-i18n": `hints.loss-area` }, "\u2BA4 Enter the area in square feet that was used to count kernels on the ground.")),
    ...
    showResults() {
        let kernelsCounted = parseInt(this.form.querySelector('[name="kernelsCounted"').value);
    ...
    static get is() { return "agc-barley-harvest-loss"; }
