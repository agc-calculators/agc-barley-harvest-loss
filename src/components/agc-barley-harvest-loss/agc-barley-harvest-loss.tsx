...
@Component({
    tag: 'agc-barley-harvest-loss'
})
export class AgcBarleyHarvestLoss {
    ...
    render() {
        return (
            <div>
                <form onSubmit={(e) => e.preventDefault()} ref={c => this.form = c as HTMLFormElement} data-wizard="agc-barley-harvest-loss" 
                    ...
                    <section data-wizard-section="0">
                      <div class="agc-wizard__field">
                        ...
                        <input name="kernelsCounted" type="number" required min="0" step="1" />
                        <p class="agc-wizard__validation-message" data-i18n="validation.kernels-counted.required" data-validates="kernelsCounted">Please enter a whole number of zero or greater.</p>
                        <p data-i18n={`hints.kernels-counted`}>⮤ Enter the number of barley kernels counted on the ground within the specified area.</p>
                      </div>
                    ...
                    <section data-wizard-section="1">
                      <div class="agc-wizard__field">
                        ...
                        <p class="agc-wizard__validation-message" data-i18n="validation.loss-area.required" data-validates="lossArea">Please enter a whole number of one or more.</p>
                        <p data-i18n={`hints.loss-area`}>⮤ Enter the area in square feet that was used to count kernels on the ground.</p>
                      </div>
                      <div class="agc-wizard__actions">
    ...
    showResults() {
            ...
            let kernelsCounted=  parseInt((this.form.querySelector('[name="kernelsCounted"') as HTMLInputElement).value);                    
            let lossArea=  parseInt((this.form.querySelector('[name="lossArea"') as HTMLInputElement).value);                    
              let yieldLoss = round(kernelsCounted / lossArea / 14, 2)      
